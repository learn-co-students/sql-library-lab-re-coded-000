...
( "Character One", "motto one", "cylon", 2, 2),
 ( "Character Two", "motto two", "human", 2, 2), ("Character Three", "motto three", "cylon", 2, 2), 
 ("Character Four", "motto four", "cylon", 2, 2);

INSERT INTO character_books (book_id, character_id) VALUES ( 1, 1), ( 1, 2), ( 2, 2), ( 3, 2), ( 1, 3), 

(2, 3), (3, 3), ( 1, 4);

INSERT INTO character_books ( book_id, character_id) VALUES (4, 5), ( 4, 6), ( 5, 6), (6, 6), 
( 4, 7), (5, 7), (6, 7), (4, 8);
